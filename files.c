...
void write_g_master_info(const gchar *group){
	...
	/*Simply return if the file could not be opened.*/
	if(!fp)
		return;
...
/*Function that writes data to the category master file.*/
